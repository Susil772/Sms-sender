...
def build_request(api, phone):
    ...
    try:
        if api == 'binge':
            ...
            h = {'Content-Type': 'application/json', 'User-Agent': 'Dart/3.9',
            ...
            h = {'Content-Type': 'application/json; charset=UTF-8', 'User-Agent': 'okhttp/5.1.0',
...
APIS = [
    ...
    'rabbithole','medeasy','jatri','shajgoj','iqralive','quizgiri','ghorerbazar','pathao','garibook'
]
